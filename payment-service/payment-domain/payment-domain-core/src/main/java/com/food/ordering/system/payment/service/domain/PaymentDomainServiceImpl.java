...
import static com.food.ordereing.system.domain.DomainConstants.*;
...
public class PaymentDomainServiceImpl implements PaymentDomainService {
	...
	public PaymentEvent validateAndCancelPayment(Payment payment,
		...
		if (failureMessages.isEmpty()) {
			...
			return new PaymentCancelledEvent(payment, ZonedDateTime.now(ZoneId.of(ZONE_ID)), failureMessages);
		} else {
